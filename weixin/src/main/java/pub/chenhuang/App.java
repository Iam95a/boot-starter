...
import pub.chenhuang.util.http.HttpUtil;
import pub.chenhuang.weixin.WXUserModel;
...
public class App {
    ...
    public static WXUserModel selfWXUserModel;
    public static List<WXUserModel> wxUserModels;
    ...
    public static void listWXUserModelByWXContactStr(String wxContactStr) {
        ...
        wxUserModels = Lists.newArrayList();
